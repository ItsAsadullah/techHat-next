...
import ProductFormInstructions from '@/components/admin/products/product-form/product-form-instructions';
import { ProductStatusWidget } from '@/components/admin/products/product-form/sections/ProductStatusWidget';
import { ProductFAQSection } from '@/components/admin/products/product-form/sections/ProductFAQSection';
...
import { AiProductPanel } from '@/components/admin/products/product-form/ai-assistant/AiProductPanel';
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function ProductForm({ categories, brands, attributesList, categoryAttributes = [], initialData }: ProductFormProps) {
          ...
          return {
            ...
            values: Array.isArray(a.values)
              ? a.values.map((v: any) => {
                ...
                return typeof v === 'string' ? { id: v, label: v } : v;
              })
              : []
          };
        });
          ...
          <div className="hidden md:block pb-24">
            ...
            <Tabs defaultValue="overview" className="w-full mt-4">
              ...
              <TabsContent value="overview" className="m-0 border-none p-0 outline-none">
                {/* ── Two-Column Grid ── */}
                <div className="grid grid-cols-12 gap-5 pt-3 max-w-[1400px] mx-auto items-start">
                  ...
                  <div className="col-span-8 space-y-4">
                    ...
                    <SectionCard title="Product Type & Variants">
                      <ProductTypeSwitcher />
                    ...
                    {/* Description — always open to prevent confusion */}
                    ...
                    <SectionCard title="Frequently Asked Questions (FAQs)">
                      <ProductFAQSection />
                    </SectionCard>
                  </div>
          ...
          <div className="md:hidden min-h-screen bg-muted/10 pb-20">
            ...
            <div className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b px-3 py-2.5 flex items-center justify-between shadow-sm">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                <AiProductPanel />
                <ProductFormInstructions iconOnly />
                <Button
                  type="button"
                  variant="outline"
                  size="icon"
            ...
            <div className="divide-y border-t">
              ...
              <MobileAccordion title="Product Type & Variants" defaultOpen>
