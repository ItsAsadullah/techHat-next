  ...
  try {
    ...
    const adjustment = await prisma.stockAdjustment.create({
      data: {
        ...
        items: {
          create: [
            { productId: simpleProduct.id, systemQty: 0, actualQty: 100, adjustedQty: 100, unitCost: 500 },
            { productId: varProduct.id, variantId: varProduct.variants[0].id, systemQty: 0, actualQty: 48, adjustedQty: 48, unitCost: 300 },
            { productId: varProduct.id, variantId: varProduct.variants[1].id, systemQty: 0, actualQty: 50, adjustedQty: 50, unitCost: 320 },
          ]
        }
      },
      include: { items: true }
      ...
      data: [
        {
          ...
          openingQty: 0, inQty: 100, outQty: 0, closingQty: 100, unitCost: 500, totalValue: 50000
        },
        {
          ...
          openingQty: 0, inQty: 48, outQty: 0, closingQty: 48, unitCost: 300, totalValue: 14400
        },
        {
          ...
          openingQty: 0, inQty: 50, outQty: 0, closingQty: 50, unitCost: 320, totalValue: 16000
        }
      ]
    });
